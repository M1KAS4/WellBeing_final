...
import com.esprit.wellbeing_final.services.rendervouService;
...
public class ListeRendevouz implements Initializable {
    ...
    //scene ajout
    public void AddRendevou() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/esprit/wellbeing_final/views/EmployeeUi/AddRendevouz.fxml"));
            Parent view = fxmlLoader.load();

            AddRendevouz addRendevouz = fxmlLoader.getController();
            addRendevouz.setLisyRend(this);
            // Assuming AddRendevouz controller requires additional initialization
            // addRendevouz.init();
    ...
    public void updateRendevou() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/esprit/wellbeing_final/views/EmployeeUi/UpdateRend.fxml"));
            Parent view = fxmlLoader.load();
            ...
            // Assuming UpdateRend controller requires additional initialization
            // updateRend.init();
            ...
            stage.initModality(Modality.WINDOW_MODAL);
            stage.initStyle(StageStyle.UTILITY);
            stage.setTitle("Modify Successfully");
